...
def main(args, env, reward_result):
...
if __name__ == "__main__":
    ...
    env = car_simulator.allCars()
    reward_result = np.zeros(6100)
    [summary_ops, summary_vars, paths] = main(args, env, reward_result)
