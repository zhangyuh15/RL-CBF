...
class OrnsteinUhlenbeckActionNoise:
    def __init__(self, mu, sigma=0.3, theta=0.15, dt=5e-2, x0=None):
        self.theta = theta
        self.mu = mu
        self.sigma = sigma
        self.dt = dt
    ...
    for i in range(int(args["max_episodes"])):
        ...
        for el in range(5):
            ...
            for j in range(int(args["max_episode_len"])):
                ...
                if agent.firstIter == 1:
                    [f, g, x, std] = dynamics_gp.get_GP_dynamics(agent, s, action_RL, t)
                else:
                    [f, g, x, std] = dynamics_gp.get_GP_dynamics_prev(agent, s, action_RL, t)
                ...
                replay_buffer.add(
                    ...
                    np.reshape(action_, (actor.a_dim,)),
                    r,
                    terminal,
