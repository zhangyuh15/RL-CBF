...
class Car:
    ...
    def nextStep(self, act, act_noise):
        ...
        a = 1.0  # Multipler for action --> acceleration
...
class allCars:
    def __init__(self):
        ...
        self.numCars = 5
        """
        self.car_1 = Car(50.0,30.0,None,None)
        self.car_2 = Car(40.0,30.0,None,self.car_1)
        self.car_3 = Car(30.0,30.0,None,self.car_2)
        self.car_4 = Car(20.0,30.0,None,self.car_3)
    ...
    def step(self, action):
        ...
        self.car_5.nextStep(self.car_5.getNextAction5(30), 0.0)
        self.car_4.nextStep(action, 0.0)
        self.car_3.nextStep(self.car_3.getNextAction(30), 0.0)
        self.car_2.nextStep(self.car_2.getNextAction(30), 0.0)
        self.car_1.nextStep(self.car_1.getNextAction(30 - 10 * np.sin(0.2 * self.t)), 0.0)
